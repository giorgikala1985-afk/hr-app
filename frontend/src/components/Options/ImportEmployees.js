        ...
        <div className="import-step-content">
          ...
          <button className="btn-excel" onClick={downloadTemplate}>
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
              <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" fill="#16a34a"/>
              <polyline points="14,2 14,8 20,8" fill="#166534" stroke="none"/>
              <line x1="6.5" y1="12" x2="17.5" y2="12" stroke="white" strokeWidth="1.3" strokeLinecap="round" opacity="0.9"/>
              <line x1="6.5" y1="15.5" x2="17.5" y2="15.5" stroke="white" strokeWidth="1.3" strokeLinecap="round" opacity="0.9"/>
              <line x1="12" y1="10" x2="12" y2="20" stroke="white" strokeWidth="1.3" strokeLinecap="round" opacity="0.9"/>
            </svg>
