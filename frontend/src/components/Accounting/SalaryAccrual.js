...
const COLUMNS = [
  ...
  { key: 'ot',          labelKey: 'salAccrual.colOT',          label: 'OT',            align: 'right', defaultWidth: 100 },
      ...
      <div className="acc-table-wrapper" style={{ overflowX: 'auto' }}>
        {loading ? (
          <TableSkeleton
            ...
            color="#479c73"
            label={t('salAccrual.loadingPayroll')}
            cols={[
              { width: '9%' }, { width: '11%' }, { width: '15%' }, { width: '13%' },
              { width: '10%', align: 'right' }, { width: '7%' }, { width: '7%' }, { width: '9%' },
            ]}
          />
        ) : !data || active.length === 0 ? (
