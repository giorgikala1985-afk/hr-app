...
import {
  Robot01Icon, Brain01Icon, ChartBarLineIcon, DollarCircleIcon, UserGroupIcon,
  Shield01Icon, StarIcon, FlashIcon, Search01Icon, File01Icon, Calculator01Icon,
  Globe02Icon, Briefcase01Icon, Wallet01Icon, BankIcon, Coins01Icon, Target01Icon,
  Rocket01Icon, Database01Icon, BellIcon, Building01Icon, CreditCardIcon,
  PieChartIcon, SparklesIcon,
...
// ── Available icons ──────────────────────────────────────────────────────────
const BOT_ICONS = [
  { key: 'bot',         label: 'Robot',       icon: Robot01Icon },
  { key: 'brain',       label: 'Brain',       icon: Brain01Icon },
  { key: 'chart',       label: 'Chart',       icon: ChartBarLineIcon },
  { key: 'dollar',      label: 'Money',       icon: DollarCircleIcon },
  { key: 'people',      label: 'People',      icon: UserGroupIcon },
  { key: 'shield',      label: 'Shield',      icon: Shield01Icon },
  { key: 'star',        label: 'Star',        icon: StarIcon },
  { key: 'lightning',   label: 'Lightning',   icon: FlashIcon },
  { key: 'search',      label: 'Search',      icon: Search01Icon },
  { key: 'document',    label: 'Document',    icon: File01Icon },
  { key: 'calculator',  label: 'Calculator',  icon: Calculator01Icon },
  { key: 'globe',       label: 'Globe',       icon: Globe02Icon },
  { key: 'briefcase',   label: 'Briefcase',   icon: Briefcase01Icon },
  { key: 'wallet',      label: 'Wallet',      icon: Wallet01Icon },
  { key: 'bank',        label: 'Bank',        icon: BankIcon },
  { key: 'coins',       label: 'Coins',       icon: Coins01Icon },
  ...
  { key: 'creditcard',  label: 'Credit Card', icon: CreditCardIcon },
  { key: 'piechart',    label: 'Pie Chart',   icon: PieChartIcon },
  { key: 'sparkles',    label: 'AI',          icon: SparklesIcon },
].map(def => ({ ...def, svg: (c, s) => <HugeiconsIcon icon={def.icon} size={s} color={c} strokeWidth={1.8} /> }));
        ...
        <div className="fb-modal-body-cols">
          ...
          <div className="fb-modal-col-left">
            ...
            <div style={{ display: 'flex', justifyContent: 'center', paddingBottom: 2 }}>
              <BotAvatar color={color} icon={icon} size={44} />
            </div>
            ...
            <div className="fb-field">
              ...
              <div className="fb-icon-grid">
                {BOT_ICONS.map(ic => (
                  ...
                  >
                    {ic.svg(icon === ic.key ? color : 'var(--text-3)', 16)}
                  </button>
                ))}
              </div>
            </div>
